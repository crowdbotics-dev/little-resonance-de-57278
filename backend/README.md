...
## Project Structure
    ...
    ├── little_resonance_de_57278  # Django project configurations
...
1. Clone this repo and `cd little_resonance_de_57278`
...
2. Clone this repo and `cd little_resonance_de_57278`
